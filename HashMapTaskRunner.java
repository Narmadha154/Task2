   ...
   public static void main(String [] args){
    ...
    switch(number){
       case 1:
          ...
          break;
       case 2:
          HashMap<String,String> stringMap=obj.findStringMapSize();
          ...
          break;
      case 3:
          HashMap<Integer,Integer> integerMap=obj.findIntegerMapSize();
         System.out.println("Hashmap elements:");
          ...
          break;
      case 4:
          HashMap<String,Integer> strIntMap=obj.createStringIntegerHashMap();
          ...
          break;
     case 6:
          HashMap<String,String> strMap=obj.findStringMapSize();
          System.out.println("Hashmap elements:");
         for(Map.Entry str : strMap.entrySet()){    
          ...
          break;
     case 7:
           HashMap<Integer,Integer> nullMap=obj.addNull();
     ...
     case 9:
           ...
           break;
     case 10:
          HashMap<String,String> changedHash=obj.changeValues();
          System.out.println("Hashmap elements:");
    ...
    case 12:
     ...
     case 13:
         ...
         break;
     case 14:
         HashMap<Integer,Integer> changedMap=obj.removeKey();
         ...
         break;
     case 15:
         HashMap<String,String> changedHashMap=obj.removeMatchedValue();
         System.out.println("Hashmap elements after changes:");
         ...
         break;
     case 16:
         HashMap<String,Integer> replacedHashMap=obj.replaceValue();
         System.out.println("Hashmap elements after changes:");
         ...
         break;
      case 17:
         HashMap<String,Integer> replacedHashMap1=obj.replaceMatchedValue();
         System.out.println("Hashmap elements after changes:");
     ...
     case 18:
          ...
          HashMap<String,Integer> transferedHashMap=obj.transferKeysValues();
          ...
          System.out.println("Size of the HashMap2 after changes:"+transferedHashSize);
           break;
      case 19:
          HashMap<String,Integer> map=obj.iterateHashMap();
          System.out.println("Hashmap elements:");
         ...
         break;
      case 20:
          HashMap<String,Integer> clearedHashMap=obj.removeAllEntries();
